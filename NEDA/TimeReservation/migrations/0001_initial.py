    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment_time', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='appointment_time_transaction', to='TimeReservation.AppointmentTime')),
            ],
        ),
        migrations.CreateModel(
            name='Bonus',
